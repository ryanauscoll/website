  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <link rel="shortcut icon" href="/logobig.png" type="image/png" />
        <link rel="shortcut icon" href="/logobig.svg" type="image/svg+xml" />
        <link rel="apple-touch-icon" href="/logobig.png" />
